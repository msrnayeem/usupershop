...
<div class="content-wrapper">
  <div class="content-header"><div class="container-fluid"><h5 class="m-0"><i class="fas fa-plus text-primary"></i> নতুন Withdrawal Method যোগ করুন</h5></div></div>
            ...
            <div class="card-body">
              <div class="form-row">
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="যেমন: bKash, Nagad, Rocket, Bank">
                  @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3 form-group">
                  <label class="font-weight-bold">Logo Emoji</label>
                  <input type="text" name="logo_emoji" value="{{ old('logo_emoji', '💳') }}" class="form-control" placeholder="💳" maxlength="5" style="font-size:20px">
                  <small class="text-muted">একটি emoji বেছে নিন</small>
                </div>
                <div class="col-md-3 form-group">
                  <label class="font-weight-bold">Brand Color</label>
                  <div class="input-group">
                    <div class="input-group-prepend"><span class="input-group-text"><input type="color" name="logo_color" value="{{ old('logo_color', '#333333') }}" style="width:24px;height:24px;border:none;padding:0;cursor:pointer"></span></div>
              ...
              <div class="form-group">
                ...
                <input type="text" name="account_label" value="{{ old('account_label', 'Mobile Number') }}" class="form-control @error('account_label') is-invalid @enderror" placeholder="যেমন: bKash নম্বর, Account নম্বর">
              ...
              <div class="form-group">
                ...
                <input type="text" name="account_placeholder" value="{{ old('account_placeholder', '01XXXXXXXXX') }}" class="form-control" placeholder="01XXXXXXXXX">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea name="instructions" rows="2" class="form-control" placeholder="যেমন: বিকাশ Personal নম্বর দিন। Agent নম্বর গ্রহণযোগ্য।">{{ old('instructions') }}</textarea>
              </div>
              <div class="form-row">
