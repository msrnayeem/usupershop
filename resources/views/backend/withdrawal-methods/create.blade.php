    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form action="{{ route('withdrawal.methods.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="e.g., bKash Personal, Nagad, Bank Transfer" required>
                                            @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label class="font-weight-bold">Logo Emoji</label>
                                            <input type="text" name="logo_emoji" value="{{ old('logo_emoji', '💳') }}" class="form-control" placeholder="💳" maxlength="5" style="font-size:18px;">
                                            <small class="text-muted">A representation emoji</small>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label class="font-weight-bold">Brand Color</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text" style="padding:4px 10px;background:#fff;"><input type="color" name="logo_color" value="{{ old('logo_color', '#333333') }}" style="width:24px;height:24px;border:none;padding:0;cursor:pointer;background:transparent;"></span></div>
                                                <input type="text" class="form-control" placeholder="#e8001d" id="colorText" value="{{ old('logo_color', '#333333') }}" onchange="document.querySelector('input[type=color]').value=this.value">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="font-weight-bold">Account Label <span class="text-danger">*</span></label>
                                        <input type="text" name="account_label" value="{{ old('account_label', 'Mobile Number') }}" class="form-control @error('account_label') is-invalid @enderror" placeholder="e.g., Wallet Account ID, Account Number, Mobile No" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="account_placeholder" value="{{ old('account_placeholder', '01XXXXXXXXX') }}" class="form-control" placeholder="e.g., 01XXXXXXXXX, 100-3452-1928">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="account_regex" value="{{ old('account_regex') }}" class="form-control" style="font-family:monospace;" placeholder="^01[3-9][0-9]{8}$">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="instructions" rows="2" class="form-control" placeholder="Describe instructions such as: Enter Personal mobile number only. Agent cashout not accepted.">{{ old('instructions') }}</textarea>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-4 form-group">
                                            <label class="font-weight-bold">Sort Order</label>
                                            <input type="number" name="sort_order" value="{{ old('sort_order', 99) }}" class="form-control" min="0" placeholder="1, 2, 3...">
                            ...
                            <div class="card mb-4" style="position:sticky;top:20px;">
                                ...
                                <div class="card-body">
                                    <div style="background:#f8fafc;border-radius:10px;padding:16px;border:1px solid #e2e8f0;">
                                        ...
                                        <label style="font-size:13px;font-weight:700;color:#0f172a;" id="previewLabel">Mobile Number</label>
                                        <input type="text" class="form-control mt-1" id="previewInput" placeholder="01XXXXXXXXX" disabled style="font-size:13px;background:#fff;">
                                    </div>
                                    <div class="mt-4">
