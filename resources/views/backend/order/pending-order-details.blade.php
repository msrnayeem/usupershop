                    ...
                    <section class="col-md-12">
                            ...
                            <div class="card-header">
                                <h5>
                                    ...
                                    <a class="btn btn-sm btn-primary float-right"
                                        href="{{ route('orders.pending.list') }}"><i class="fas fa-list"></i> Pending Order
                                        List</a>
                                </h5>
                            </div>
                            <!-- /.card-header -->
                        ...
                        @endphp
                            <div class="card-body">
                                ...
                                <table id="OrderPenTable" class="text-center myTable" border="1" width="100%">
                                    <tr>
                                        <td width="30%">
                                            <img src="{{ asset('frontend/assets/images/12345.png') }}"
                                                style="color:blue;width:280px;" alt="{{ $logo->name }}">
                                        </td>
                                        <td width="40%">
                                ...
                                <a id="approve" class="btn btn-sm btn-primary float-right mt-3"
                                    href="{{ route('orders.approve') }}" data-token="{{ csrf_token() }}"
                                    data-id="{{ $order->id }}"><i class="fas fa-check"></i> Delivered</a>
                                    <a style="margin-right: 5px;" href="{{ route('orders.print',$order->id) }}"  class="btn btn-sm btn-info float-right mt-3" href="#">
