...
@section('content')
    ...
    <script>
        $(function () {
            ...
            let orderTbl = $("#OrderTbl").DataTable({
                processing: true,
                serverSide: true,
            ...
            $('#OrderTbl').on('click', '.checkedOrds', function() {
                updateSelectedOrders();
            });
            ...
            $("#bulkCourierBtn").click(function() {
                ...
                if (confirm(`Are you sure you want to assign ${selectedODRs.length} orders to courier?`)) {
                    showLoading();
                    $.ajax({
                        type: 'POST',
                        ...
                        error: function(xhr) {
                            hideLoading();
                            showAlert('error', xhr.responseJSON?.message || "Failed to assign courier");
                        }
                    });
                }
            });
