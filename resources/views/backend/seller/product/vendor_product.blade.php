...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:22px;flex-wrap:wrap;gap:12px;">
            ...
            <a class="btn btn-sm btn-primary" href="{{ route('vendor.addproduct') }}" style="display:inline-flex;align-items:center;gap:6px;padding:9px 18px;background:#6366f1;border:none;border-radius:8px;font-size:13px;font-weight:600;color:#fff;text-decoration:none;">
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="card-title">
                            ...
                            List of active/pending catalog products
                        </span>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
        ...
        $(function() {
            $("#productTbl").DataTable({
                ...
                columns: [
                    ...
                    { data: "sku", name: "sku" },
                    { data: "tp", name: "trade_price" },
                    { data: "price", name: "price" },
                    { data: "discount", name: "discount" },
                    { data: "disValue", name: "disValue", searchable: false, orderable: false },
