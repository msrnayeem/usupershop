                    ...
                    <div class="col-12">
                        <div class="card card-warning card-outline">
                            <div class="card-header">
                                <h3 class="card-title">Pending Order Details</h3>
                                <a class="btn btn-sm btn-secondary float-right"
                                    href="{{ route('seller.orders.pending.list') }}">
                                    <i class="fas fa-list"></i> Pending Orders List
                                </a>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <!-- Print Button -->
                                <div class="px-4 pb-4 no-print mt-3">
                                    <a href="{{ route('seller.orders_print', $order->id) }}"
                                        class="btn btn-info btn-sm float-right" target="_blank">
