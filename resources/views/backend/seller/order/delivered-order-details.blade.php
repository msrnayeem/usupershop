        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:22px;flex-wrap:wrap;gap:12px;">
            <div>
                ...
                <p style="color:#64748b;font-size:13px;margin:2px 0 0;">
                    ...
                    <a href="{{ route('seller.orders.delivered.list') }}" style="color:#6366f1;text-decoration:none;">Delivered Orders</a>
                    <span style="margin:0 6px;color:#cbd5e1;">/</span>
                    Details
                </p>
            </div>
            <a class="btn btn-sm btn-primary" href="{{ route('seller.orders.delivered.list') }}" style="display:inline-flex;align-items:center;gap:6px;padding:9px 18px;background:#6366f1;border:none;border-radius:8px;font-size:13px;font-weight:600;color:#fff;text-decoration:none;">
                <i class="fas fa-list"></i> Delivered List
            </a>
        </div>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <div style="display:flex;align-items:center;gap:12px;margin-bottom:15px;">
                                    <div style="background:#dcfce7;color:#16a34a;width:44px;height:44px;border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:18px;">
                ...
                <div class="row justify-content-end mb-4">
                    <div class="col-md-5">
                        ...
                        <div class="text-right">
                            <a href="{{ route('seller.orders_print', $order->id) }}" class="btn btn-info px-4 font-weight-bold" target="_blank" style="background:#0284c7;border:none;border-radius:8px;padding:10px 20px;">
