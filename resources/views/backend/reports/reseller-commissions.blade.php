        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:22px;flex-wrap:wrap;gap:12px;">
            <div>
                <h1 style="font-size:22px;font-weight:800;color:#0f172a;margin:0;">
                    <i class="fas fa-handshake" style="color:#6366f1;margin-right:8px;"></i>
                    {{ $pageTitle }}
                </h1>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center py-5 text-muted">
                                                <i class="fas fa-percent fa-3x mb-2" style="opacity:0.8;"></i>
                                                <p style="font-weight:600;margin-bottom:0;color:#1e293b;">No Reseller Commission Data Found</p>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
