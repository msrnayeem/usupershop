                                                            ...
                                                            <form action="{{ route('seller.processPayment') }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="seller_type" id="seller_type"
                                                                        ...
                                                                        @foreach ($dropshipperFees as $fee)
                                                                            <option value="{{ $fee->account_type_of_dropshipper }}">
                                                                                {{ $fee->account_type_of_dropshipper ?? '' }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
        ...
        $("#seller_type").change(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success' && response.dropshipperFee) {
                        const subscriptionFee = response.dropshipperFee.subscription_fees || 0;
