                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>
                                    Edit Profile
                                    <a class="btn btn-sm btn-primary float-right" href="{{ route('dropshipper.view.profile') }}"><i
                                            class="fas fa-list"></i> Your Profile</a>
                                </h5>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form method="post" action="{{ route('dropshipper.update.profile') }}" id="myForm"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <img id="showImage" style="width: 120px;height:130px; border:1px solid #000"
