        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:22px;flex-wrap:wrap;gap:12px;">
            <div>
                <h1 style="font-size:22px;font-weight:800;color:#0f172a;margin:0;">
                    ...
                    @if (isset($editData)) Edit Dropshipper @else Add Dropshipper @endif
                </h1>
                <p style="color:#64748b;font-size:13px;margin:2px 0 0;">
                    <a href="{{ route('home') }}" style="color:#6366f1;text-decoration:none;">Home</a>
                    <span style="margin:0 6px;color:#cbd5e1;">/</span>
                    <a href="{{ route('dropshippers.view') }}" style="color:#6366f1;text-decoration:none;">Dropshipper</a>
                    <span style="margin:0 6px;color:#cbd5e1;">/</span>
            ...
            <a class="btn btn-sm btn-primary" href="{{ route('dropshippers.view') }}" style="display:inline-flex;align-items:center;gap:6px;padding:9px 18px;background:#6366f1;border:none;border-radius:8px;font-size:13px;font-weight:600;color:#fff;text-decoration:none;">
                <i class="fas fa-list"></i> Dropshippers List
            </a>
        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <span class="card-title">
                                    ...
                                    Dropshipper Profile Form
                                </span>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{ route('dropshippers.update', $editData->id) }}" id="myForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="email">Dropshipper Email</label>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="password">Dropshipper Password (Optional)</label>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="mobile">Dropshipper Phone No</label>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="address">Dropshipper Address</label>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="shop_name">Dropshipper Shop Name</label>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="subscription_plan">Dropshipper Subscription Plan (Y-M-D)</label>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="image">Dropshipper Image</label>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="logo">Dropshipper Shop Logo</label>
