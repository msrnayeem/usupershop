                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <div class="btn-group">
                                        <a href="{{ route('dropshipper.reports.commission.pdf') }}" class="btn btn-sm btn-danger">
                                            <i class="fas fa-file-pdf"></i> PDF
                                        </a>
                                        <a href="{{ route('dropshipper.reports.commission.excel') }}" class="btn btn-sm btn-success">
