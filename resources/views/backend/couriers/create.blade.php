            ...
            <div class="card">
                <div class="card-header">
                    <span class="card-title">
                        <i class="fas fa-plus" style="color:#6366f1;margin-right:6px;"></i>
                        New Courier Integration Parameters
                    </span>
                </div>
                <div class="card-body">
                    <form action="{{ route('couriers.store') }}" method="POST" id="myForm">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="client_id" id="client_id" class="form-control" placeholder="Enter API Client ID">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="client_secret" style="font-weight:600;color:#334155;font-size:13px;">Client Secret Key</label>
                                <input type="text" name="client_secret" id="client_secret" class="form-control" placeholder="Enter API Client Secret">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="api_key" style="font-weight:600;color:#334155;font-size:13px;">API Key</label>
                                <input type="text" name="api_key" id="api_key" class="form-control" placeholder="Enter Carrier API Secret Key">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="store_id" style="font-weight:600;color:#334155;font-size:13px;">Store ID / Hub ID</label>
                                <input type="text" name="store_id" id="store_id" class="form-control" placeholder="Enter Merchant Hub Store ID">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-12 text-right" style="margin-top:20px;border-top:1px solid #e2e8f0;padding-top:20px;margin-bottom:0;">
                                <button type="submit" class="btn btn-primary" style="background:#6366f1;border:none;padding:10px 30px;border-radius:8px;font-weight:600;">
                                    <i class="fas fa-save mr-1"></i> Save Courier Config
                                </button>
                            </div>
                        </div>
                    </form>
