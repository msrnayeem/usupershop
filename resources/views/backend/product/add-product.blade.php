                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                        ...
                                                        <div class="card-body" style="padding: 20px;">
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col-6">
                                                                    ...
                                                                    <input type="number" name="quantity" class="form-control" id="quantity" placeholder="Qty" required min="0">
                                                    ...
                                                    <div class="card mb-4" style="border: 1px solid #e2e8f0; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
                                                        ...
                                                        <div class="card-body" style="padding: 20px;">
                                                            <div class="form-group">
                                                                <label style="font-weight:600; color:#334155; font-size:13px;">Primary Image <span class="text-danger">*</span></label>
                                                                <input type="file" name="image" id="image" class="form-control" required>
                                                                <span style="color: red;">{{ $errors->first('image') }}</span>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-3 d-flex align-items-center justify-content-center">
                                                                    <img id="showImage" style="width:50px; height:50px; border-radius:8px; border:1px solid #e2e8f0; object-fit:cover; display:none;">
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="meta_title" class="form-control" id="meta_title" placeholder="SEO Title">
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-6">
                                                                    <label for="meta_description" style="font-weight:600; color:#334155; font-size:13px;">Meta Description</label>
                                                                    <textarea name="meta_description" class="form-control" id="meta_description" placeholder="SEO Description" rows="2"></textarea>
                                                                </div>
                                                                <div class="form-group col-6">
                                                                    <label for="meta_keywords" style="font-weight:600; color:#334155; font-size:13px;">Meta Keywords</label>
                                                                    <textarea name="meta_keywords" class="form-control" id="meta_keywords" placeholder="Keywords" rows="2"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body" style="padding: 20px;">
                                                            ...
                                                            <div class="card shadow-sm border-0 mb-3" style="background:#f8fafc;border:1px solid #e2e8f0 !important;border-radius:10px;">
                                                                <div class="card-body p-3">
                                                                    ...
                                                                    <p class="text-muted" style="font-size:11px;margin-bottom:10px;">Click generate below after choosing colors & sizes.</p>
                                                            ...
                                                            <div class="card border-0" style="border:1px solid #e2e8f0 !important;border-radius:10px;">
                                                                <div class="card-header" style="background:#f8fafc;border-bottom:1px solid #e2e8f0;padding:10px 15px;">
                                                                    <span class="card-title" style="font-size:12px;font-weight:700;"><i class="fas fa-list-alt mr-1" style="color:#6366f1;"></i> Generated Combinations</span>
                                                                </div>
                                                                <div class="card-body" style="padding:5px;">
                                                                    <div id="color-size-combinations" style="max-height:280px;overflow-y:auto;background:#fff;border-radius:8px;padding:5px;">
                                                                        <div class="text-center text-muted py-3">
                                                                            ...
                                                                            <p style="margin-bottom:4px;font-weight:600;font-size:12px;">No combinations generated yet.</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
