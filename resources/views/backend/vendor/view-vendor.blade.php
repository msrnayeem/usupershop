                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left">
                                                    <div>
                                                        ...
                                                        {{ optional($vendor->created_at)->format('d M Y, h:i A') ?? '--' }}
                                                    </div>
                                                    <div class="mt-1">
                                                        <small class="d-block text-muted">Active</small>
                                                        {{ optional($vendor->activated_at ?: $vendor->created_at)->format('d M Y, h:i A') ?? '--' }}
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center" style="width: 200px;">
                                                    ...
                                                    @if ($vendor->status == 0)
                                                        <a title="Active" class="btn btn-sm btn-success" href="{{ route('vendors.status', ['id' => $vendor->id, 'status' => '1']) }}">Active</a>
                                                    @elseif ($vendor->status == 1)
                                                        <a title="Inactive" class="btn btn-sm btn-warning" href="{{ route('vendors.status', ['id' => $vendor->id, 'status' => '0']) }}">Inactive</a>
                                                    @else
                                                        <a title="Inactive" class="btn btn-sm btn-warning" href="{{ route('vendors.status', ['id' => $vendor->id, 'status' => '0']) }}">Inactive</a>
                                                    @endif
                                                    

                                                    <a title="Suspend" class="btn btn-sm btn-secondary" href="{{ route('vendors.status', ['id' => $vendor->id, 'status' => '2']) }}">Suspend</a>

                                                    @if ($vendor->payment_status == 0)
                                                        <a title="Paid" class="btn btn-sm btn-success" href="{{ route('vendors.payment_status', ['id' => $vendor->id, 'payment_status' => '1']) }}">Paid</a>
                                                    @endif
                                                    @if ($vendor->payment_status == 1)
                                                        <a title="Unpaid" class="btn btn-sm btn-warning" href="{{ route('vendors.payment_status', ['id' => $vendor->id, 'payment_status' => '0']) }}">Unpaid</a>
                                                    @endif



                                                    <a title="Edit" class="btn btn-sm btn-primary" href="{{ route('vendors.edit', $vendor->id) }}">
                                                    ...
                                                    <a title="Vendor Profile" class="btn btn-sm btn-success" href="{{ route('vendors.profile.verify', $vendor->id) }}">
                                                        <i class="fas fa-users"></i> Vendor Profile
                                                    </a>
                                                </td>
