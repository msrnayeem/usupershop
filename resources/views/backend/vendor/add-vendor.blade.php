    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h5 class="m-0"><i class='fas fa-hand-point-right'></i> Manage Vendor</h5>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>
                                    ...
                                    <a class="btn btn-sm btn-primary float-right" href="{{ route('vendors.view') }}"><i
                                            class="fas fa-list"></i> All Vendor</a>
                                </h5>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form method="post"
                                    action="{{route('vendors.update', $editData->id)}}"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="name">Vendor Password</label>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="name">Vendor Phone No</label>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="name"> Vendor Shop Logo</label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="name">Vendor Shop Name</label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="name">Vendor Subscription Plan</label>
