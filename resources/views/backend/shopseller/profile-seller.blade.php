                                    ...
                                    <tbody>
                                        @if ($profiles!=null)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('sellers.profile_delete',$profiles->user_id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete verification profile?')">
