    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h5 class="m-0"><i class='fas fa-hand-point-right'></i> Profile Seller</h5>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                                        ...
                                        <tbody>
                                            @if ($profiles!=null)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('sellers.profile_delete',$profiles->user_id) }}" class="btn btn-sm btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                            @endif
                                        </tbody>
