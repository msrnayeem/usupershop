...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:22px;flex-wrap:wrap;gap:12px;">
            ...
            <a class="btn btn-sm btn-primary" href="{{ route('coupons.add') }}" style="display:inline-flex;align-items:center;gap:6px;padding:9px 18px;background:#6366f1;border:none;border-radius:8px;font-size:13px;font-weight:600;color:#fff;text-decoration:none;">
                ...
                <div class="row">
                    <section class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="couponTbl" class="table table-bordered table-striped nowrap dt-responsive" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th width="6%" class="text-center">SN</th>
                                            <th class="text-center">Title</th>
                                            <th class="text-center">Code</th>
                                            <th class="text-center">Start Offer</th>
                                            <th class="text-center">End Offer</th>
        ...
        $(function() {
            $("#couponTbl").DataTable({
                ...
                columns: [
                    ...
                    {data: "promoCode", name: "promoCode", className: "text-center"},
                    ...
                    {data: "min_amount", name: "min_amount", className: "text-center"},
