...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6"><h5 class="m-0"><i class="fas fa-user-plus text-primary"></i> Staff Edit করুন</h5></div>
        <div class="col-sm-6">
          ...
          <div class="col-md-7">
            ...
            <div class="card shadow-sm mb-3">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" value="{{ old('name', \$staff->user->name ?? '') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Staff-এর নাম">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div id="roleInfo" style="font-size:13px;color:#888;margin-top:4px"></div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="email" name="email" value="{{ old('email', \$staff->user->email ?? '') }}" class="form-control @error('email') is-invalid @enderror" placeholder="email@example.com">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="mobile" value="{{ old('mobile', \$staff->user->mobile ?? '') }}" class="form-control @error('mobile') is-invalid @enderror" placeholder="01XXXXXXXXX" maxlength="11">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="font-weight-bold">🔒 নতুন Password <span class="badge badge-secondary" style="font-size:12px">Optional</span></label>
                      <div class="input-group">
                        <input type="password" name="new_password" id="pw" class="form-control @error('password') is-invalid @enderror" placeholder="কমপক্ষে ৬ অক্ষর">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="font-weight-bold">🔒 Confirm Password <span class="badge badge-secondary" style="font-size:12px">Optional</span></label>
                      <div class="input-group">
                        <input type="password" name="new_password_confirmation" id="pw2" class="form-control" placeholder="আবার টাইপ করুন">
                        <div class="input-group-append">
                    ...
                    <div class="permission-card {{ in_array($key, old('permissions', \$staff->permissions ?? [])) ? 'selected' : '' }}"
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div>
                          ...
                          <div style="font-size:12px;color:#888;font-family:monospace">{{ implode(', ', $module['routes']) }}</div>
                        </div>
                        <div class="ml-auto">
                          <input type="checkbox" name="permissions[]" value="{{ $key }}"
                            id="perm_{{ $key }}" {{ in_array($key, old('permissions', \$staff->permissions ?? [])) ? 'checked' : '' }}
            ...
            <div class="form-group mb-3">
              <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label font-weight-bold" for="isActive">Account Active রাখুন</label>
              </div>
            </div>
