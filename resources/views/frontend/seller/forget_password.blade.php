                                    ...
                                    <div class="card">
                                        ...
                                        @endif
                                            <form id="login-form" class="form"
                                                action="{{ route('seller.forgetpassword.save') }}" method="post">
                                                @csrf
                                                ...
                                                <div class="row">
                                                    <div class="offset-sm-3 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="email" class="mb-2">Your Emial or 
                                                                Phone Number<span
                                                                    style="color: red;">*</span></label>
                                                            <input type="text" name="content" class="form-control"
                                                                placeholder="Email address or Phone Number" value="{{ Session::get('seller_verify') }}" readonly>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="mobile" class="mb-2">Password <span
                                                                    style="color: red;">*</span></label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="mobile" class="mb-2">Confirm Password <span
                                                                    style="color: red;">*</span></label>
