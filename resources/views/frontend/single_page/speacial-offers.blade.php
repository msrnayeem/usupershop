...
@section('title', 'Special Offers | ' . config('app.name'))

@section('meta_description', 'Check out special offers at ' . config('app.name') . ' — get amazing discounts on
    groceries, cosmetics, healthcare, baby products, and more. Limited-time deals, shop now!')
@section('meta_keywords', 'Special Offers, Discounts, Sale, Limited-Time Deals, Hot Deals, ' . config('app.name'))
@section('meta_author', config('app.name'))

@push('meta')
    {{-- Open Graph / Facebook --}}
    <meta property="og:title" content="Special Offers - {{ config('app.name') }}" />
    <meta property="og:description"
        content="Grab amazing discounts on groceries, cosmetics, healthcare, baby products, and more at {{ config('app.name') }}. Limited-time deals!" />
    ...
    <meta name="twitter:title" content="Special Offers - {{ config('app.name') }}">
                                ...
                                <div class="card-body">
                                    <div class="row store-products">
                                        @forelse ($products as $product)
                                            <div class="col-sm-6 col-md-3 col-xs-6 " style="margin: 10px 0px;">
                                                <div class="product">
