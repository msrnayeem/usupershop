<style type="text/css">
    ...
    .product-item-carousel .stars,
    .product-item-carousel .rating,
    .product-item-carousel .review,
    .product-item-carousel .reviews,
    .new_productsTab .stars,
    .new_productsTab .rating,
    .product-slider .rating,
    .product-slider .stars,
    .product-slider .review-count,
...
════════════════════════════════════════════════════════ */
    ...
    *::after {
    ...
    @media (max-width: 768px) {
        ...
        .product-single .product-title h1 {
    ...
    *::after {
    ...
    @media (max-width: 768px) {
        ...
        .related-products .owl-carousel::-webkit-scrollbar {
            display: none !important;
        }
        ...
        .seller-orders td,
        .dropshipper-orders td {
            font-size: 13px !important;
            padding: 8px !important;
        }

        .seller-orders .badge,
        .dropshipper-orders .badge {
            font-size: 13px !important;
        }
        ...
        .login-form-wrap .btn-lg,
        .signup-form-wrap .btn-lg {
            padding: 13px !important;
            font-size: 15px !important;
            border-radius: 12px !important;
            width: 100% !important;
...
════════════════════════════════════════════════════════════ */
    ...
    * {
    ...
    @media (max-width: 767px) {
        ...
        .basket .glyphicon-shopping-cart::before {
            content: '🛒' !important;
        ...
        #categorySliderSection .category_area {
            text-align: center !important;
            cursor: pointer !important;
        }
        ...
        #categorySliderSection .category_area:active img.img-circle {
            border-color: #e8001d !important;
        }
