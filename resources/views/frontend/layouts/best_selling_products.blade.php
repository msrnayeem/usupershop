<div id="product-tabs-slider" class="scroll-tabs outer-top-vs">
    <div class="more-info-tab clearfix">
        <h3 class="new-product-title pull-left english_lang">Best Seller</h3>
        <h3 style="display: none;" class="new-product-title pull-left bangla_lang">বেস্ট সেলার</h3>
    </div>

    <div class="tab-content outer-top-xs" style="padding-left: 0px;">
        <div class="tab-pane in active" id="all">
            <div class="product-slider">
                <div class="owl-carousel best_selling custom-carousel owl-theme" data-item="6">
                    @forelse ($topProducts as $items)
